...
Console.WriteLine("Enter an integer value betwee 1 and 42");
...
do
{
    ...
    validNum = int.TryParse(valueEntered, out numVal);

    if (validNum)
    {
        if (numVal < 1 || numVal > 42)
        {
            validNum = false;
            Console.WriteLine("The value entered is out of range. Please enter an integer value between 1 and 42");
        } else
        {
            Console.WriteLine($"You entered {numVal}");
        }
    } else
    {
        Console.WriteLine("The value entered is not a valid integer. Please enter an integer value between 1 and 42");
    }
